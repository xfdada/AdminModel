...
insert  into `lk_category`(`c_id`,`c_name`,`c_pid`,`c_time`) values (1,'延长器',0,NULL),(2,'手机延长器',1,NULL),(3,'电视延长器',1,NULL),(4,'手机视频延长器',2,NULL),(5,'视频转接器',0,NULL),(6,'无线视频转接器',5,NULL),(7,'手机无线延长器',2,NULL),(9,'手机',0,'2020-02-17 17:23:55'),(10,'手机无线延长器',4,'2020-02-17 18:08:37'),(11,'电视无线延长器',1,'2020-02-17 18:09:16');
...
insert  into `lk_product`(`p_id`,`p_name`,`c_id`,`p_icon`,`p_img`,`p_desc`,`is_hot`,`is_new`,`is_show`,`p_detail`,`p_params`,`p_pack`,`p_time`) values (2,'手机无线延长器',2,NULL,NULL,'这是一张手机无线投屏器',1,1,1,NULL,NULL,NULL,'2020-02-24 11:22:35');

...
<head>
    ...
    <title><?php echo $__env->yieldContent('title'); ?></title>
        ...
        <!-- Bootstrap core CSS-->
        <link href="<?php echo e(asset('plugins/bootstrap-datatable/css/dataTables.bootstrap4.min.css')); ?>" rel="stylesheet" type="text/css">
        ...
        <div id="sidebar-wrapper" data-simplebar="" data-simplebar-auto-hide="true">
            <div class="brand-logo">
                <a href="../后台模板/index.html">
                    <img src="<?php echo e(asset('images/logo-icon.png')); ?>" class="logo-icon" alt="logo icon">
                    <h5 class="logo-text">管理后台</h5>
                </a>
            </div>
            <div class="user-details">
                <div class="media align-items-center user-pointer collapsed" data-toggle="collapse" data-target="#user-dropdown">
                    <div class="avatar"><img class="mr-3 side-user-img" src="<?php echo e(asset('images/avatars/avatar-13.png')); ?>" alt="user avatar"></div>
                ...
                <ul class="navbar-nav align-items-center right-nav-link">
                            ...
                            <ul class="list-group list-group-flush">
                                ...
                                <li class="list-group-item">
                                    <a href="javaScript:void();">
                                        <div class="media">
                                            <div class="avatar"><img class="align-self-start mr-3" src="<?php echo e(asset('images/avatars/avatar-5.png')); ?>" alt="user avatar"></div>
                                            <div class="media-body">
                                ...
                                <li class="list-group-item">
                                    <a href="javaScript:void();">
                                        <div class="media">
                                            <div class="avatar"><img class="align-self-start mr-3" src="<?php echo e(asset('images/avatars/avatar-6.png')); ?>" alt="user avatar"></div>
                                            <div class="media-body">
                                ...
                                <li class="list-group-item">
                                    <a href="javaScript:void();">
                                        <div class="media">
                                            <div class="avatar"><img class="align-self-start mr-3" src="<?php echo e(asset('images/avatars/avatar-7.png')); ?>" alt="user avatar"></div>
                                            <div class="media-body">
                                ...
                                <li class="list-group-item">
                                    <a href="javaScript:void();">
                                        <div class="media">
                                            <div class="avatar"><img class="align-self-start mr-3" src="<?php echo e(asset('images/avatars/avatar-8.png')); ?>" alt="user avatar"></div>
                                            <div class="media-body">
                    ...
                    <li class="nav-item">
                        <a class="nav-link dropdown-toggle dropdown-toggle-nocaret" data-toggle="dropdown" href="#">
                            <span class="user-profile"><img src="<?php echo e(asset('images/avatars/avatar-13.png')); ?>" class="img-circle" alt="user avatar"></span>
                        </a>
                        <ul class="dropdown-menu dropdown-menu-right">
                            <li class="dropdown-item user-details">
                                <a href="javaScript:void();">
                                    <div class="media">
                                        <div class="avatar"><img class="align-self-start mr-3" src="<?php echo e(asset('images/avatars/avatar-13.png')); ?>" alt="user avatar"></div>
                                        <div class="media-body">
...
<?php /**PATH C:\phpstudy_pro\WWW\AdminModel\resources\views/layouts/head.blade.php ENDPATH**/ ?>
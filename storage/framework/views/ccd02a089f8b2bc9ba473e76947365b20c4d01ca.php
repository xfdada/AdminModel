...
<script>
    layui.use( ['upload','form'], function() {
        ...
        form.on('submit(demo1)', function(data){
            $.post('/banner',{_token: '<?php echo csrf_token(); ?>',data:data.field},function(res){
                if(res.code===0){
...
</html><?php /**PATH C:\phpstudy_pro\WWW\AdminModel\resources\views/admin/Banner_create.blade.php ENDPATH**/ ?>
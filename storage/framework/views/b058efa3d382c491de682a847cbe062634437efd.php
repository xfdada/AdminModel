...
<?php $__env->startSection('title', '固件资源管理'); ?>
    ...
    <script>
        ...
        layui.use('table', function(){
            ...
            form.on('switch(sexDemo)', function(obj){
                ...
                $.post('/res/is_show/'+obj.value,{_token: "<?php echo csrf_token(); ?>",value:value},function(res){
                    if(res.code===0){
            ...
            table.on('tool(test3)', function(obj){
                ...
                if(obj.event === 'del'){
                    layer.confirm('真的删除行么', function(index){
                        $.post('/resources/'+data.r_id,{_method:'delete','_token': "<?php echo csrf_token(); ?>"},function(res){
                            if(res.code===0){
                                obj.del();
                                layer.msg(res.msg,{icon:6});
                            }else{
...
<?php echo $__env->make('layouts.head', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\phpstudy_pro\WWW\AdminModel\resources\views/admin/Productresource_list.blade.php ENDPATH**/ ?>
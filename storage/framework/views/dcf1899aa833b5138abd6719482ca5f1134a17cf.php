...
<?php $__env->startSection('title', '新闻列表'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <link href="<?php echo e(asset('plugins/bootstrap-switch/bootstrap-switch.min.css')); ?>" rel="stylesheet">
    <style>
        .layui-form-onswitch{
    ...
    <script>
        ...
        layui.use('table', function(){
            ...
            form.on('switch(sexDemo)', function(obj){
                ...
                $.post('/news/is_show/'+obj.value,{_token: "<?php echo csrf_token(); ?>",value:value},function(res){
                    if(res.code===0){
            ...
            table.on('tool(test3)', function(obj){
                ...
                if(obj.event === 'del'){
                    layer.confirm('真的删除行么', function(index){
                        $.post('/news/'+data.n_id,{_method:'delete','_token': "<?php echo csrf_token(); ?>"},function(res){
                            if(res.code===0){
                                obj.del();
                                layer.msg(res.msg,{icon:6});
                            }else{
...
<?php echo $__env->make('layouts.head', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\phpstudy_pro\WWW\AdminModel\resources\views/admin/News_list.blade.php ENDPATH**/ ?>
...
<script>
    layui.use( ['upload','form'], function() {
        ...
        form.on('submit(demo1)', function(data){
            $.post('/resources',{_token: '<?php echo csrf_token(); ?>',data:data.field},function(res){
                if(res.code===0){
...
</html><?php /**PATH F:\PHPProgram\AdminModel\resources\views/admin/Productresource_create.blade.php ENDPATH**/ ?>
    ...
    <script>
        ...
        layui.use(['table'], function(){
            ...
            table.on('edit(test3)', function(obj){
                ...
                $.post('/comment/replay/'+data.cm_id,{replay:value,'_token': "<?php echo csrf_token(); ?>"},function(res){
                    if (res.code===5){
            ...
            form.on('switch(sexDemo)', function(obj){
                ...
                $.post('/comment/is_show/'+obj.value,{_token: "<?php echo csrf_token(); ?>",value:value},function(res){
                    if(res.code===0){
                        layer.msg(res.msg,{icon:6});
                    }else{
                        layer.msg(res.msg,{icon:5});

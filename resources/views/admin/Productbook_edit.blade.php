     ...
     <div class="layui-form-item">
       <label class="layui-form-label">名称</label>
        <div class="layui-input-block">
            <input type="text" hidden name="b_url" id="book_url" value="{{$res->b_url}}">
            <input type="text" name="b_name" lay-verify="title"value="{{$res->b_name}}" ay-verify="required" autocomplete="off"  placeholder="请输入说明书名称" class="layui-input">
         </div>
     </div>

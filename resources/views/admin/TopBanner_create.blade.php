     ...
     <div class="layui-form-item">
       <label class="layui-form-label">所属页面</label>
        <div class="layui-input-block">
            <input type="text" name="tb_name" lay-verify="title" autocomplete="off" required placeholder="请输入页面名称" class="layui-input">
         </div>
     </div>
    <div class="layui-form-item" style="height: 120px">
        <label for="layui-form-label">上传banner图</label>
        <div style="display: flex;margin-left:100px;position: relative;top: -30px;">
            <div class="layui-upload">
                ...
                <input type="text" hidden id="n_icon" lay-verify="required" lay-reqtext="banner必须上传" name="tb_url">
            </div>
...
<script>
    layui.use( ['upload','form'], function() {
        ...
        form.on('submit(demo1)', function(data){
            $.post('/my_admin/top_banner',{_token: '{!! csrf_token() !!}',data:data.field},function(res){
                if(res.code===0){

...
namespace resources\Verify;
class Verify {
    protected $config =	array(
        'seKey'     =>  'Xfdada',   // 验证码加密密钥
...
//        dd(dirname(__FILE__). '/' . ($this->useZh ? 'zhttfs' : 'ttfs') . '/');exit;
        // 验证码使用随机字体
        ...
        $secode['verify_time'] = time();  // 验证码创建时间ssssssssssssssssssssssssssssssssssssssssssssss
